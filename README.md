...
🎯 **Первый этап завершен** | 📊 **Получены достойные результаты** | 🚀 **Готов к этапу Reinforcement Learning**
...
| **LSTM** | **94.30%** | **76.35%** | 81.48% | **78.83%** | **97,2%** | 93.5 мин |
...
### 📋 Основные отчеты
- **[Научный отчет](reports/research_report.md)** (80+ страниц) - Полное исследование в формате Markdown
