...
from ..utils.metrics import calculate_metrics, evaluate_anomaly_detection, print_metrics_report
...
class LSTMEvaluator(Evaluator):
    ...
    def evaluate_anomaly_detection(self, normal_loader, attack_loader, threshold_method='percentile', 
                                  threshold_value=95):
        """
